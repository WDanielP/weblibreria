...
<body>
	...
	<form action="add" method="post" class="needs-validation" novalidate>
		...
		<div class="form-group">
			<label for="numPaginas" class="form-label">N° de Paáginas</label>
		...
		<button class="btn btn-primary" type="button" onclick="window.location.href='/ismac-libreria-web-nocturno/libros2/findAll'; return false;">
					Cancelar
		</button>
	</form>
</div>
